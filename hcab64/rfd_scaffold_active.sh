...
inference.output_prefix=A1/8w0w_A1 inference.input_pdb=8w0w_clean.pdb \
...
inference.ckpt_override_path=/home/paperspace/apps/RFdiffusion/models/ActiveSite_ckpt.pt \
