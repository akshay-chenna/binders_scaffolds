...
def binder_bb_rmsd(u,v):
        u = mda.Universe(u)
        u = u.select_atoms('chainID A and (name CA or name C or name N)')
        v = mda.Universe(v)
        v = v.select_atoms('chainID A and (name CA or name C or name N)')
...
def motif_bb_rmsd(u,v):
        u = mda.Universe(u)
        u = u.select_atoms('chainID A and ((name CA or name C or name N) and (' + l + ') )')
        v = mda.Universe(v)
        v = v.select_atoms('chainID A and ((name CA or name C or name N) and (' + l + ') )')
